...
ax2.plot(mid_point,integrate.cumtrapz(y=histo_total_adjust, x=mid_point,initial=0),'--', label = 'Weibull')
ax2.set_xlabel('v (m/s)')
ax2.set_ylabel('CDF')
legend(loc='center right')
tight_layout()

plt.savefig('../../StratosphericPropulsion/PaperSerio/eps_foto/wind2_total.eps', format='eps', dpi=1000)
